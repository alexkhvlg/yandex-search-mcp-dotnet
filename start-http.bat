...
cd /d "%~dp0"
start "yandex-mcp-http" dotnet run -c Release -- --api-key %YANDEX_CLOUD_API_KEY% --folder-id %YANDEX_CLOUD_FOLDER_ID% --transport http --host 0.0.0.0 --port 5883 --proxy-url http://172.16.3.1:3128
